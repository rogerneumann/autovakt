...
import com.rogerneumann.autovakt.data.LightingMode
import com.rogerneumann.autovakt.data.PidRangeDefaults
import com.rogerneumann.autovakt.data.SlotDisplayType
import com.rogerneumann.autovakt.data.UnitSystem
...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupCloseButton()
        binding.tvVersion.text = "AutoVakt v${BuildConfig.VERSION_NAME}"
    ...
    private fun setupDashboardLayoutSection() {
        ...
        binding.btnSavedVehicles.setOnClickListener {
            startActivity(Intent(this, com.rogerneumann.autovakt.ui.vehicles.SavedVehiclesActivity::class.java))
        }
    }
    ...
    private fun setupBridgeSection() {
        ...
        binding.btnBridgeCopy.setOnClickListener {
            ...
            clipboard.setPrimaryClip(ClipData.newPlainText("AutoVakt Bridge address", address))
